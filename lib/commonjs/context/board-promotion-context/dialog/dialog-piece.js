...
const DialogPiece = exports.DialogPiece = /*#__PURE__*/_react.default.memo(({
  index,
  width,
  type,
  piece,
  ...
  return /*#__PURE__*/_react.default.createElement(_reactNativeGestureHandler.GestureDetector, {
    ...
    style: [{
      ...
      borderTopColor: index % 2 !== 0 ? 'rgba(255,255,255,0.1)' : 'transparent',
      borderLeftColor: index === 3 || index === 2 ? 'rgba(255,255,255,0.1)' : 'transparent'
