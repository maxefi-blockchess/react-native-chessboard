...
const BoardOperationsContextProviderComponent = /*#__PURE__*/_react.default.forwardRef((_ref, ref) => {
  ...
  const toggleIsPieceGestureInProgress = (0, _react.useCallback)(() => setIsPieceGestureInProgress(!isPieceGestureInProgress), [isPieceGestureInProgress]);
  ...
  }, [isPromoting, moveTo, onMove, onSelectPiece, selectableSquares, selectedSquare, turn, moveProgrammatically, isPieceGestureInProgress, toggleIsPieceGestureInProgress]);
